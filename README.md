...
| Artifact | Version |
| --- | --- |
| `io.proximi.sdk:proximiio` | `6.0.0-beta.9` |
| `io.proximi.sdk:proximiio-blueiot` | `6.0.0-beta.9` |
...
manifest. At SDK `6.0.0-beta.9` and map `6.0.0-beta.10` the merged manifest holds:
