...
| Artifact | Version |
| --- | --- |
| `io.proximi.sdk:proximiio` | `6.0.0-beta.15` |
| `io.proximi.sdk:proximiio-blueiot` | `6.0.0-beta.15` |
...
manifest. At SDK `6.0.0-beta.15` and map `6.0.0-beta.12` the merged manifest holds:
